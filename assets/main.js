...
(function() {
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Load',
										'page_location': 'https://carrd.co/templates/0d2e5216e76062d5',
									});
								},
								function() { 
									window._sectionTimeoutId = setTimeout(function() { location.href = '#pbswfl'; }, 4000);
								},
							],
						},
					},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Pbswfl',
										'page_location': 'https://carrd.co/templates/0d2e5216e76062d5/#pbswfl',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'About',
										'page_location': 'https://carrd.co/templates/0d2e5216e76062d5/#about',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Partners',
										'page_location': 'https://carrd.co/templates/0d2e5216e76062d5/#partners',
									});
								},
							],
						},
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										...
										'page_location': 'https://carrd.co/templates/0d2e5216e76062d5/#mentoring',
									});
								},
							],
						},
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										...
										'page_location': 'https://carrd.co/templates/0d2e5216e76062d5/#financial',
									});
								},
							],
						},
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										...
										'page_location': 'https://carrd.co/templates/0d2e5216e76062d5/#workforce',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Contact',
										'page_location': 'https://carrd.co/templates/0d2e5216e76062d5/#contact',
									});
								},
							],
						},
					...
					'contact-done': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Contact-done',
										'page_location': 'https://carrd.co/templates/0d2e5216e76062d5/#contact-done',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Openmenu',
										'page_location': 'https://carrd.co/templates/0d2e5216e76062d5/#openmenu',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Sponsor',
										'page_location': 'https://carrd.co/templates/0d2e5216e76062d5/#sponsor',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Events',
										'page_location': 'https://carrd.co/templates/0d2e5216e76062d5/#events',
									});
								},
							],
						},
	...
	// Initialize background.
		(function() {
			...
			new slideshowBackground('siteBg', {
				target: '.site-bg',
				wait: 0,
				order: 'default',
				transition: {
				...
				images: [
					{
						src: 'assets/images/bg-9da7ac9a.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/bg-628379fe.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/bg-4a8c2ad2.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/bg-7d10c19f.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
	...
	// Initialize "On Visible" animations.
		onvisible.add('.container-component.instance-15', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.instance-12', { style: 'zoom-out', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.container-component.instance-18', { style: 'zoom-out', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.container-component.instance-6', { style: 'fade-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.text-component.instance-32', { style: 'flip-forward', speed: 1000, intensity: 5, threshold: 3, delay: 1000, replay: true });
		onvisible.add('.text-component.instance-22', { style: 'flip-backward', speed: 1000, intensity: 5, threshold: 3, delay: 2000, replay: true });
		onvisible.add('.image-component.instance-15', { style: 'pop-in', speed: 1000, intensity: 5, threshold: 3, delay: 3000, replay: true });
		onvisible.add('.text-component.instance-28', { style: 'flip-forward', speed: 1000, intensity: 5, threshold: 3, delay: 1000, replay: true });
		onvisible.add('.text-component.instance-30', { style: 'flip-backward', speed: 1000, intensity: 5, threshold: 3, delay: 2000, replay: true });
